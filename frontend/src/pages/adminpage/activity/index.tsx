...
import { FaPlus, FaTrash, FaEdit, FaCalendarAlt, FaImage, FaBullhorn } from "react-icons/fa";
...
function Activity() {
  ...
  const indexOfLastAnnounce = currentPage * ActivityPerPage;
  const indexOfFirstAnnounce = indexOfLastAnnounce - ActivityPerPage;
  const currentActivity = filteredActivities.slice(indexOfFirstAnnounce, indexOfLastAnnounce);  

  const deleteActivitiesById = async (id: string) => {
    if (!window.confirm("คุณแน่ใจที่จะลบกิจกรรมนี้ใช่หรือไม่?")) return;
      ...
      <div className="activity-card">
        <div className="header-section">
          ...
          <div className="header-actions">
            ...
            <Link to="/admin/activity/create" className="create-button">
          ...
          <div className="table-container">
            {filteredActivities.length === 0 ? (
              <div className="no-results">
                <p>ไม่พบข้อมูลกิจกรรมที่ตรงกับการค้นหา</p>
              </div>
            ) : (
                ...
                <tbody>
                  {currentActivity.map((activity) => (
                    <tr key={activity.ID} className="activity-row">
                      <td>
                        <span className="id-cell">{activity.ID}</span>
                      </td>
                      <td>
                      ...
                      <td>
                        <div className="action-buttons">
                          <button
                            ...
                            onClick={() => deleteActivitiesById(String(activity.ID))}
                            title="ลบกิจกรรม"
                          >
                            <FaTrash />
                          ...
                          <button
                            ...
                            onClick={() => navigate(`/admin/activity/edit/${activity.ID}`)}
                            title="แก้ไขกิจกรรม"
                          >
                            <FaEdit />
