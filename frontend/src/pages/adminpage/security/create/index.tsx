...
import { FaPlus, FaTimes, FaShieldAlt, FaAlignLeft, FaImage, FaUpload } from "react-icons/fa";
...
function SecurityCreate() {
  ...
  return (
    <div className="security-create-container">
      <div className="security-create-card">
        <div className="card-header">
          <div className="header-icon">
            <FaShieldAlt />
          </div>
          <h1>เพิ่มข้อมูลข่าวสารความปลอดภัย</h1>
