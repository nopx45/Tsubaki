...
import { FaSave, FaTimes, FaShieldAlt, FaAlignLeft, FaImage, FaUpload } from "react-icons/fa";
...
function SecurityEdit() {
  ...
  const handleImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files[0]) {
      ...
      setSecurity({ originFileObj: selectedFile } as unknown as ImageUpload);
    ...
    <div className="security-edit-container">
      <div className="security-edit-card">
        <div className="card-header">
          ...
          <h1>แก้ไขข้อมูลข่าวสารความปลอดภัย</h1>
        ...
        <form onSubmit={onFinish} className="security-form">
          ...
          <div className="form-group">
            ...
            <div className="image-upload-container">
              ...
              {(previewImage || prevSecurityImage) && (
                <div className="image-preview-container">
                  <img
                    src={previewImage || `http://192.168.0.85:8080/${prevSecurityImage}`}
                    alt="Preview"
