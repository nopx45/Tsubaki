      ...
      >
        ...
        <Form name="basic" layout="vertical" onFinish={onFinish} autoComplete="off">
          <Row gutter={[16, 16]}>
            <Col xs={24}>
              <Form.Item
                label="ชื่อหัวข้อข่าวสาร IT"
                name="title"
                rules={[
                  { required: true, message: "กรุณากรอกหัวข้อข่าวสาร !" },
                ]}
              >
            ...
            <Col xs={24}>
              <Form.Item
                ...
                name="content"
                rules={[
                  { required: true, message: "กรุณากรอกรายละเอียดข่าวสาร !" },
                ]}
              >
            ...
            <Col xs={24}>
              <Form.Item
                ...
                name="Image"
                rules={[
                  { required: true, message: "กรุณาอัพโหลดรูปภาพข่าวสาร !" },
                ]}
              >
                <Upload
                  beforeUpload={(file) => {
