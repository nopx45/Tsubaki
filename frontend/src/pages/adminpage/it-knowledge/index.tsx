...
function ITKnowledges() {
  ...
  const deleteKnowledgesById = async (id: string) => {
    if (!window.confirm("คุณแน่ใจที่จะลบข่าวสารนี้ใช่หรือไม่?")) return;
      ...
      <div className="it-knowledge-card">
        <div className="card-header">
          ...
          <div className="header-actions">
            ...
            <Link to="/admin/it-knowledge/create" className="create-button">
                      ...
                      <td>
                        <div className="action-buttons">
                          <button
                            ...
                            onClick={() => navigate(`/admin/it-knowledge/edit/${knowledge.ID}`)}
                          >
                            <FaEdit />
                          ...
                          <button
                            ...
                            onClick={() => deleteKnowledgesById(String(knowledge.ID))}
                          >
                            <FaTrash />
