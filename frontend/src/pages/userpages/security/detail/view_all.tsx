...
import { GetSecurity } from "../../../../services/https/index";
import { Outlet, useNavigate } from "react-router-dom";
import dayjs from "dayjs";
import { SecurityInterface } from "../../../../interfaces/ISecurity";
import { FaShieldAlt, FaIdCard, FaImage, FaSearch, FaPaperPlane } from "react-icons/fa";
      ...
      <div className="security-card">
        <div className="header-section">
          <div className="title-wrapper">
            ...
            <h1>หน้ารวมข่าวสารด้านความปลอดภัย</h1>
          </div>
                      ...
                      <td>
                        <div className="action-buttons">
                          <button
                            ...
                            onClick={() => navigate(`/security/detail/${item.ID}`)}
                          >
                            <FaPaperPlane />
