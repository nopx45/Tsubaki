...
import { GetTrainings } from "../../../../services/https/index";
          ...
          <div className="table-container">
            {currentTraining.length === 0 ? (
              <div className="no-results">
                ...
                <h3>ไม่พบข้อมูลการอบรมที่ตรงกับการค้นหา</h3>
                <p>ลองเปลี่ยนคำค้นหาหรือสร้างการอบรมใหม่</p>
              </div>
            ) : (
              <table className="training-table">
                ...
                <tbody>
                  {currentTraining.map((training) => (
                    ...
                    >
                      <td>
                        <span className="id-cell">{training.ID}</span>
                      </td>
                      <td>
                      ...
                      <td>
                        <span className="content-cell">
                          {training.content
                            ? training.content.length > 30 
                              ? training.content.substring(0, 30) + "..." 
                              : training.content
                            : "-"}
                        </span>
                      </td>
