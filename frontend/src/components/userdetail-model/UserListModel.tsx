...
import { Modal, List, Button, Avatar, Divider } from "antd";
...
interface UserListModalProps {
  ...
  onClose: () => void;
  onSelectUser: (user: UsersInterface) => void;
}

const UserListModal: React.FC<UserListModalProps> = ({ open, users, onClose, onSelectUser }) => {
