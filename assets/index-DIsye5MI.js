import{E as A,r as n,j as e,aR as w,aF as V,aC as y,aG as o,q as B,aH as E,aA as q,aY as $}from"./index-Wslmr7s8.js";function O(){const N=A(),[c,p]=n.useState(!1),[u,F]=n.useState(null),[m,k]=n.useState(null),[x,S]=n.useState(null),[f,C]=n.useState(null),[l,z]=n.useState(null),[d,P]=n.useState(null),[g,T]=n.useState(null),[h,I]=n.useState(null),[b,L]=n.useState(null),r=(a,t)=>{const i=document.createElement("div");i.className=`notification ${a}`,i.innerHTML=`
