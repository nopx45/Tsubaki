import{E as se,ah as re,r as n,j as e,az as X,aF as le,aC as l,aG as d,q as de,aH as ce,aI as pe,bd as ue,S as me,be as xe}from"./index-Wslmr7s8.js";function he(){const v=se(),{id:u}=re(),[w,m]=n.useState(!1),[x,j]=n.useState(),[f,N]=n.useState(),[h,y]=n.useState(),[g,k]=n.useState(),[b,F]=n.useState(),[z,S]=n.useState(null),[C,P]=n.useState(null),[I,L]=n.useState(null),[M,T]=n.useState(null),[s,G]=n.useState(null),[B,V]=n.useState(null),[U,R]=n.useState(null),[D,A]=n.useState(null),[$,E]=n.useState(null),r=(a,t)=>{const i=document.createElement("div");i.className=`notification ${a}`,i.innerHTML=`
