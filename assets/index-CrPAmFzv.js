import{E as A,r as s,j as e,az as j,aF as V,aC as N,aG as o,q as Y,aH as B,aA as E,S as q,aN as H}from"./index-Wslmr7s8.js";function X(){const y=A(),[p,F]=s.useState(null),[u,d]=s.useState(!1),[m,k]=s.useState(null),[x,z]=s.useState(null),[g,C]=s.useState(null),[l,S]=s.useState(null),[c,T]=s.useState(null),[h,L]=s.useState(null),[f,M]=s.useState(null),[b,P]=s.useState(null),r=(a,t)=>{const i=document.createElement("div");i.className=`notification ${a}`,i.innerHTML=`
